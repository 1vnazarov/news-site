...
== 📌 About ==
Simple and powerful currency exchange rates widget for your website or blog. Included 190+ world currencies with popular cryptocurrencies. Updates each hour automatically. Multi Language support: English, Русский, Italiano, Français, Español, Deutsch, 中国.

[DEMO 1](https://currencyrate.today/exchangerates-widget) 👀
[DEMO 2](https://codepen.io/currencyrate_today/pen/QWqdJXw) 👀
📩 Feel free, write if you will have any questions: [Online support](https://t.me/converter_support)

= ⭐️ FEATURES ⭐️ =
1. 190+ [Currencies](https://currencyrate.today/different-currencies) and Popular [CryptoCurrencies](https://currencyrate.today/other);
...
💰 Your might like it:
🔵 [Currency Converter Widget](https://wordpress.org/plugins/currency-converter-calculator/)
